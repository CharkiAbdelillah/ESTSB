...
function thinkup_input_blogdate() {
	printf( __( '<span class="date"><a href="%1$s" title="%2$s"><time datetime="%3$s"><span class="date-month">%4$s</span></time></a></span>', 'ESTSB' ),
		esc_url( get_permalink() ),
		esc_attr( get_the_title() ),
	...
	if ( '0' != get_comments_number() ) {
		echo	'<span class="comment">';
			if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) {;
				comments_popup_link( __( '<span class="comment-count">0</span> <span class="comment-text">Comments</span>', 'ESTSB' ), __( '<span class="comment-count">1</span> <span class="comment-text">Comment</span>', 'ESTSB' ), __( '<span class="comment-count">%</span> <span class="comment-text">Comments</span>', 'ESTSB' ) );
			};
		echo	'</span>';
	}
}
...
$categories_list = get_the_category_list( __( ', ', 'ESTSB' ) );
...
$tags_list = get_the_tag_list( '', __( ', ', 'ESTSB' ) );
...
function thinkup_input_blogauthor() {
	printf( __( '<span class="author"><a href="%1$s" title="%2$s" rel="author">%3$s</a></span>', 'ESTSB' ),
		esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
		esc_attr( sprintf( __( 'View all posts by %s', 'ESTSB' ), get_the_author() ) ),
		get_the_author()
	);
}
