...
function thinkup_customizer_theme_options( $wp_customize ) {
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => esc_html__( 'ESTSB Pro', 'ESTSB' ),
				'priority'     => 1,
				'button_text' => esc_html__( 'Upgrade Now', 'ESTSB' ),
				'button_url'  => 'https://www.thinkupthemes.com/themes/ESTSB/',
	...
	$wp_customize->add_section(
		new thinkup_customizer_customswitch_button_link(
			...
			array(
				'title'        => esc_html__( 'Documentation', 'ESTSB' ),
				'priority'     => 1,
				'button_text' => __( 'View Docs', 'ESTSB' ),
	...
	$wp_customize->add_panel(
		...
		array(
			'title'       => esc_html__( 'Theme Options', 'ESTSB' ),
			'description' => esc_html__( 'Use the options below to customize your theme!', 'ESTSB' ),
			'priority'    => 2,
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'General Settings', 'ESTSB' ),
			'priority' => 10,
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Homepage', 'ESTSB' ),
			'priority' => 20,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Homepage (Featured)', 'ESTSB' ),
			'priority' => 30,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Social Media', 'ESTSB' ),
			'priority' => 60,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_section(
		...
		array(
			'title'    => esc_html__( 'Upgrade (10% off)', 'ESTSB' ),
			'priority' => 80,
			'panel'    => $prefix_name . 'thinkup_customizer_section_themeoptions',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Logo Settings', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Since WordPress v4.5 you can now add a site logo using the native WordPress options. To add a site logo go the "Site Identitiy" settings on the main customizer screen.', 'ESTSB' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Page Structure', 'ESTSB' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'			  => esc_html__( 'Page Layout', 'ESTSB' ),
				'description'	  => esc_html__( 'Select page layout. This will only be applied to published Pages.', 'ESTSB' ),
				'choices'		  => array(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_generalsettings',
			'type'			  => 'select',
			'label'			  => esc_html__( 'Select a Sidebar', 'ESTSB' ),
			'description'	  => esc_html__( 'Choose a sidebar to use with the page layout.', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'           => esc_html__( 'Enable Fixed Layout', 'ESTSB' ),
				'description'	  => esc_html__( '(i.e. Disable responsive layout)', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'           => __( 'Enable Breadcrumbs', 'ESTSB' ),
				'description'	  => __( 'Switch on to enable breadcrumbs.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_generalsettings',
			'type'			  => 'text',
			'label'			  => __( 'Breadcrumb Delimiter', 'ESTSB' ),
			'description'	  => __( 'Specify a custom delimiter to use instead of the default &#40; / &#41;.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Backup Theme Options', 'ESTSB' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_generalsettings',
				'label'           => esc_html__( 'Backup Theme Options', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to backup your theme options settings each time the customizer is updated and saved. If enabled then a new page called "ThinkUp Created Content Backup" will be created where the option values can be found.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
				'active_callback' => '',
			)
		)
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Control Homepage Layout', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'			  => esc_html__( 'Homepage Layout', 'ESTSB' ),
				'description'	  => esc_html__( 'Select page layout. This will only be applied to static homepages (front page) and not to homepage blogs.', 'ESTSB' ),
				'choices'		  => array(
					'option1' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option01.png',
					'option2' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option02.png',
					'option3' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option03.png',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'select',
			'label'			  => esc_html__( 'Select a Sidebar', 'ESTSB' ),
			'description'	  => esc_html__( 'Choose a sidebar to use with the layout.', 'ESTSB' ),
			'choices'		  => thinkup_customizer_select_array_sidebar(),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'           => esc_html__( 'Homepage Slider', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'radio',
			'label'			  => esc_html__( 'Choose Homepage Slider', 'ESTSB' ),
			'description'	  => esc_html__( 'Switch on to enable home page slider.', 'ESTSB' ),
			'choices'		  => array(
				'option4' => esc_html__( 'Image Slider', 'ESTSB' ),
				'option3' => esc_html__( 'Disable', 'ESTSB' ),
			),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Slide 1', 'ESTSB' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			array(
				...
				'label'	          => '',
				'description'	  => esc_html__( 'Image', 'ESTSB' ),
				'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'			  => '',
			'description'	  => esc_html__( 'Title', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'			  => '',
			'description'	  => esc_html__( 'Description', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'dropdown-pages',
			'label'			  => '',
			'description'	  => esc_html__( 'URL', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Slide 2', 'ESTSB' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_raw(
			...
			array(
				'label'           => esc_html__( 'Slide 3', 'ESTSB' ),
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'           => esc_html__( 'Enable Full-Width Slider', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to enable full-width slider.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'label'			  => esc_html__( 'Slider Height (Max)', 'ESTSB' ),
			'description'	  => esc_html__( 'Specify the maximum slider height (px).', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepage',
				'label'           => esc_html__( 'Call To Action - Intro', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Message', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to enable intro on home page.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'description'	  => wp_kses_post( __( 'Enter a <strong>title</strong> message.<br /><br />This will be one of the first messages your visitors see. Use this to get their attention.', 'ESTSB' ) ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'description'	  => wp_kses_post( __( 'Enter a <strong>teaser</strong> message.<br /><br />Use this to provide more details about what you offer.', 'ESTSB' ) ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'text',
			'label'	          => esc_html__( 'Button - Text', 'ESTSB' ),
			'description'	  => esc_html__( 'Specify a text for button 1.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'radio',
			'label'			  => esc_html__( 'Button - Link', 'ESTSB' ),
			'description'	  => esc_html__( 'Specify whether the action button should link to a page on your site, out to external webpage or disable the link altogether.', 'ESTSB' ),
			'choices'		  => array(
				'option1' => esc_html__( 'Link to a Page', 'ESTSB' ),
				'option2' => esc_html__( 'Specify Custom link', 'ESTSB' ),
				'option3' => esc_html__( 'Disable Link', 'ESTSB' ),
			),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'dropdown-pages',
			'label'			  => esc_html__( 'Button - Link to a page', 'ESTSB' ),
			'description'	  => esc_html__( 'Select a target page for action button link.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);	
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepage',
			'type'			  => 'text',
			'label'			  => esc_html__( 'Button - Custom link', 'ESTSB' ),
			'description'	  => esc_html__( 'Input a custom url for the action button link. Add http:// if linking to an external webpage.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Display Pre-Designed Homepage', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'           => esc_html__( 'Enable Pre-Made Homepage', 'ESTSB' ),
				'description'	  => esc_html__( 'switch on to enable pre-designed homepage layout.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'	          => esc_html__( 'Content Area 1', 'ESTSB' ),
				'description'	  => esc_html__( 'Add an image for the section background.', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Add a title to the section.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'textarea',
			'description'	  => esc_html__( 'Add some text to featured section 1.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			=> 'dropdown-pages',
			'label'			=> esc_html__( 'Link to a page', 'ESTSB' ),
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'	          => esc_html__( 'Content Area 2', 'ESTSB' ),
				'description'	  => esc_html__( 'Add an image for the section background.', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'textarea',
			'description'	  => esc_html__( 'Add some text to featured section 2.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Media_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
				'label'	          => esc_html__( 'Content Area 3', 'ESTSB' ),
				'description'	  => esc_html__( 'Add an image for the section background.', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_homepagefeatured',
			'type'			  => 'textarea',
			'description'	  => esc_html__( 'Add some text to featured section 3.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'label'           => esc_html__( 'Control Pre-Header Content', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'         => $prefix_name . 'thinkup_customizer_section_header',
			'type'			  => 'radio',
			'label'			  => esc_html__( 'Choose Pre Header Style', 'ESTSB' ),
			'description'	  => esc_html__( 'Specify the pre header style.', 'ESTSB' ),
			'choices'		  => array(
				'option1' => esc_html__( 'Style 1 (Dark)', 'ESTSB' ),
				'option2' => esc_html__( 'Style 2 (Light)', 'ESTSB' ),
			),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_header',
				'label'           => esc_html__( 'Enable Search (Pre Header)', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to enable header search.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_header',
				'label'           => esc_html__( 'Control Header Content', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_header',
				'label'           => esc_html__( 'Enable Search (Main Header)', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to enable header search.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Control Footer Content', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_footer',
				'label'			  => esc_html__( 'Footer Widgets Layout', 'ESTSB' ),
				'description'	  => esc_html__( 'Select footer layout. Take complete control of the footer content by adding widgets.', 'ESTSB' ),
				'choices'		  => array(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_footer',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Disable Footer Widgets', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to disable footer widgets.', 'ESTSB' ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_footer',
				'label'           => __( 'Enable Scroll To Top', 'ESTSB' ),
				'description'	  => __( 'Check to enable scroll to top.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Social Media Control', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Enable Social Media Links (Pre Header)', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to enable links to social media pages.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Enable Social Media Links (Footer)', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to enable links to social media pages.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Social Media Content', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => wp_kses_post( __( 'Add a message here. E.g. &#34;Follow Us&#34;.<br />(Only shown in header)', 'ESTSB' ) ),
			'active_callback' => '',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Facebook', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to Facebook profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Facebook page.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to use custom Facebook icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'description'	  => esc_html__( 'Add a link to the image or upload one from your desktop. The image will be resized.', 'ESTSB' ),
				'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Twitter', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to Twitter profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Twitter page.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to use custom Twitter icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Google+', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to Google+ profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Google+ page.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to use custom Google+ icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'LinkedIn', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to LinkedIn profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your LinkedIn page.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to use custom LinkedIn icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'Flickr', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to Flickr profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'	  => esc_html__( 'Input the url to your Flickr page.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to use custom Flickr icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'YouTube', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to YouTube profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'     => esc_html__( 'Input the url to your YouTube page.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Check to use custom YouTube icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_socialmedia',
				'label'           => esc_html__( 'RSS', 'ESTSB' ),
				'description'	  => esc_html__( 'Enable link to RSS profile.', 'ESTSB' ),
				'choices'		  => array(
					'1'      => esc_html__( 'On', 'ESTSB' ),
					'off'    => esc_html__( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		  => $prefix_name . 'thinkup_customizer_section_socialmedia',
			'type'			  => 'text',
			'description'     => esc_html__( 'Input the url to your RSS feed.', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'checkbox',
			'label'			  => esc_html__( 'Custom Icon', 'ESTSB' ),
			'description'	  => esc_html__( 'Use Custom RSS Icon', 'ESTSB' ),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				'label'           => esc_html__( 'Control Blog (Archive) Pages', 'ESTSB' ),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
				'label'			  => esc_html__( 'Blog Layout', 'ESTSB' ),
				'description'	  => esc_html__( 'Select blog page layout. Only applied to the main blog page and not individual posts.', 'ESTSB' ),
				'choices'		  => array(
					'option1' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option01.png',
					'option2' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option02.png',
					'option3' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option03.png',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			  => 'select',
			'label'			  => esc_html__( 'Select a Sidebar', 'ESTSB' ),
			'description'	  => esc_html__( 'Note: Sidebars will not be applied to homepage Blog. Control sidebars on the homepage from the &#39;Home Settings&#39; option.', 'ESTSB' ),
			'choices'		  => thinkup_customizer_select_array_sidebar(),
			'active_callback' => $prefix_name . 'thinkup_customizer_callback_active_global',
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> $prefix_name . 'thinkup_customizer_section_blog',
			'type'			=> 'radio',
			'label'			=> esc_html__( 'Blog Traditional Layout', 'ESTSB' ),
			'description'	=> wp_kses_post( __( 'Select a layout for your blog page. This will also be applied to all pages set using the blog template.', 'ESTSB' ) ),
			'choices'		=> array(
				'option1' => esc_html__('Style 1 (Quarter Width)', 'ESTSB' ),
				'option2' => esc_html__('Style 2 (Full Width)', 'ESTSB' ),
			)
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> $prefix_name . 'thinkup_customizer_section_blog',
			'type'			=> 'radio',
			'label'			=> esc_html__( 'Post Content', 'ESTSB' ),
			'description'	=> wp_kses_post( __( 'Control how much content you want to show from each post on the main blog page. Remember to control the full article content by using the WordPress <a href="http://en.support.wordpress.com/splitting-content/more-tag/">more</a> tag in your post.', 'ESTSB' ) ),
			'choices'		=> array(
				'option1' => esc_html__( 'Show excerpt', 'ESTSB' ),
				'option2' => esc_html__( 'Show full article', 'ESTSB' ),
				'option3' => esc_html__( 'Hide article', 'ESTSB' ),
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_section(
			...
			array(
				...
				'section'         => $prefix_name . 'thinkup_customizer_section_blog',
				'label'           => esc_html__( 'Control Single Post Page', 'ESTSB' ),
				'active_callback' => '',
			)
		)
	);
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_radio_image(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
				'label'			  => esc_html__( 'Post Layout', 'ESTSB' ),
				'description'	  => esc_html__( 'Select blog page layout. This will only be applied to individual posts and not the main blog page.', 'ESTSB' ),
				'choices'		  => array(
					'option1' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option01.png',
					'option2' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option02.png',
					'option3' => trailingslashit( esc_url( get_template_directory_uri() ) ) . 'admin/main/assets/img/layout/blog/option03.png',
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_switch(
			...
			array(
				...
				'section'		  => $prefix_name . 'thinkup_customizer_section_blog',
				'label'           => esc_html__( 'Show Social Sharing', 'ESTSB' ),
				'description'	  => esc_html__( 'Switch on to enable social media sharing..', 'ESTSB' ),
				'choices'		  => array(
					'1'      => __( 'On', 'ESTSB' ),
					'off'    => __( 'Off', 'ESTSB' ),
				),
	...
	$wp_customize->add_control(
		new thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'upgrade_url'     => 'https://www.thinkupthemes.com/themes/ESTSB/',
				'price_discount'  => esc_html__( 'Upgrade for $31 (10% off)', 'ESTSB' ),
				'price_normal'	  => esc_html__( 'Normally $35. Use coupon at checkout.', 'ESTSB' ),
				'coupon'	      => esc_html__( 'ESTSB31', 'ESTSB' ),
				'button'	      => esc_html__( 'Upgrade Now', 'ESTSB' ),
				'title_main'	  => esc_html__( 'So&hellip; Why upgrade?', 'ESTSB' ),
				'title_secondary' => esc_html__( 'We&#39;re glad you asked! Here&#39;s just some of the amazing features you&#39;ll get when you upgrade&hellip;', 'ESTSB' ),
				'images'		  => array(
