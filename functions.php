<?php
/**
 * Setup theme functions for ESTSB.
 *
...
if ( ! function_exists( 'thinkup_themesetup' ) ) {
	...
	function thinkup_themesetup() {
		...
		load_theme_textdomain( 'ESTSB', get_template_directory() . '/languages' );
		...
		register_nav_menus( array( 'pre_header_menu' => __( 'Pre Header Menu', 'ESTSB' ) ) );
		register_nav_menus( array( 'header_menu'     => __( 'Primary Header Menu', 'ESTSB' ) ) );
		register_nav_menus( array( 'sub_footer_menu' => __( 'Footer Menu', 'ESTSB' ) ) );
	}
}
...
function thinkup_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Sub-Footer Column 1', 'ESTSB' ),
        'id'            => 'sub-footer-w1',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Sub-Footer Column 2', 'ESTSB' ),
        'id'            => 'sub-footer-w2',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="sub-footer-widget-title"><span>',
